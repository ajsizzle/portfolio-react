        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I am a self-taught full-stack web developer. I love exploring new technologies and constantly learning and applying these skills to my toolset. My current focus is on solidifying my understanding of React.js by applying the library to current and future projects. I'm also working on mobile development by learning Dart and Flutter.</p>
                    <p>There's nothing quite like the feeling of creating something out of nothing and making it work. This is my craft and I practice every day to get one step closer to mastering it.</p>
