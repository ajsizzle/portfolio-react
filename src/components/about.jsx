        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I am a self-taught full-stack web developer. I love exploring new technologies and constantly learning and applying these skills to my toolset. My current focus is on solidifying my understanding of React.js and Node.js by applying both ends to current and future projects.</p>
